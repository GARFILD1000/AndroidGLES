...
class Shader(vertexShaderSource: String, fragmentShaderSource: String) {
    val program: Int = createProgram(vertexShaderSource, fragmentShaderSource)
    ...
    fun getAttributeLocation(attribute: String) = glGetAttribLocation(program, attribute)

    fun getUniformLocation(uniform: String) = glGetUniformLocation(program, uniform)
